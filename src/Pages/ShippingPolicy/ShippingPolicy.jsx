        ...
        <>
            <div className="info_pages container_layout mx-auto flex justify-center items-center flex-col "  >
                ...
                <ul>
                    ...
                    <li>If you find that the package appears to be tampered with, please refuse delivery and return the package to the courier or delivery person. Additionally, notify us immediately at info@voltcart.com so we can address the issue with our logistics partner.</li>
                </ul>
                ...
                <ul>
                    ...
                    <li><strong>No exchange or return</strong> is available for international orders. For any product-related inquiries, please contact us via email <a href="#">info@voltcart.com</a> before placing your order.</li>
