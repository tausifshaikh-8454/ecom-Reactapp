...
const SkeletonLoaderProduct = () => {
    return (
        <div className=" w-full flex justify-center items-start gap-[20px] h-[75vh] pt-[50px] " >
            ...
            <div role="status" className="space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center w-full px-[50px] ">
                <div className="flex items-center justify-center w-[80%] min-h-[310px] bg-gray-300 rounded-sm dark:bg-gray-400">
