        ...
        <div className="joinus-sec w-full m-auto bg-no-repeat bg-cover bg-center bg-fixed opacity-black-80 relative " style={{ backgroundImage: `url(${purpose})` }}>
            <div className="container_layout m-auto">
                <div className="flex items-center justify-center flex-col gap-[20px] tab:py-[140px] py-[80px]  " >
                    <h2 className="font-primary gt-tab:text-[50px]/[60px] tab:text-[45px]/[50px] text-[38px]/[42px] font-[200] text-white z-[99] " >Join Us</h2>
                    <p className="font-body tab:text-[18px]/[28px] text-[16px]/[26px] font-[300] text-center py-[10px] text-white z-[99] " >Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi soluta ipsam blanditiis, aut qui repudiandae eos mollitia esse numquam impedit sapiente consequatur suscipit amet officia omnis alias ipsa! Libero, odio!
